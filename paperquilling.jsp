...
rs=st.executeQuery("select * from paperquilling where type='Studs'");
while(rs.next())
{%>
</br></br>
<%
...
Class.forName("com.mysql.jdbc.Driver").newInstance();
st=con.createStatement();
rs=st.executeQuery("select * from paperquilling where type='Hangings'");
while(rs.next())
{%>
</br></br>
<%
...
Class.forName("com.mysql.jdbc.Driver").newInstance();
st=con.createStatement();
rs=st.executeQuery("select * from paperquilling where type='Jhumkas'");
while(rs.next())
{%>
</br></br>
<%
...
Class.forName("com.mysql.jdbc.Driver").newInstance();
st=con.createStatement();
rs=st.executeQuery("select * from paperquilling where type='Set'");
while(rs.next())
{%>
</br></br>
<%
